...
import getAccessToken from "@/app/lib/auth/github/getAccessToken";
import getUserEmail from "@/app/lib/auth/github/getUserEmail";
import getUserProfile from "@/app/lib/auth/github/getUserprofile";
import { setSessionId } from "@/app/lib/setSessionId";
...
export async function GET(request: NextRequest) {
  ...
  if (user) {
    ...
    await setSessionId({ id: newUser.id });
  }
  return redirect("/profile");
}
